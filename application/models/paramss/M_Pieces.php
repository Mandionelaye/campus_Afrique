<?php
class M_Pieces extends  MY_Model
{
   ...
   {
      return $this->db->insert('lst_types_pieces', $data);
   }
   ...
   function update_one_s($id_val, $data)
   {
      ...
      return $this->db->update('lst_types_pieces', $data);
   }
}
