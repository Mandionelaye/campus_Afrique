...
class M_connexion_comptes extends  CI_Model
{
   ...
   {
      $this->db->insert('c_candidats', $data);
   ...
   public function identification($login)
	{
		...
		$sql_ll = " SELECT u.email email,u.etat, u.id, u.img_profil FROM c_candidats u		";
   ...
   public function identification_ok($login,$mdp)
	{
		...
		$sql_ll = "
         SELECT u.id id,u.email email,u.etat ,u.code_candidat,CONCAT(u.prenom,' ',u.nom) _the_name, u.img_profil
         FROM c_candidats u		
		";
