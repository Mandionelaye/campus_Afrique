...
?>
    <div class='row'>
        <div class='col-sm-12' style='margin-bottom: 30px'>
            <a href="<?php echo site_url('params-ajouter-langue');  ?>">
                                      ...
                                      //  {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value->date_creation; ?></td>
                                                 ...
                                                 <td>   <a href="<?php echo site_url('params-details-langue/' . $value->id);  ?>" class='on-default btn_edit' id='<?php echo $value->id; ?>'>
                                                    <?php 
                                                        if($value->etat=='1')
                                                            {
