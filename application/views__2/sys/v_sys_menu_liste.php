...
<div class='row'>
    <div class='col-sm-12' style='margin-bottom: 30px'>
        <a href="<?php echo site_url('params-ajouter-menu');  ?>">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class='actions' style='width: 1%; text-align: center; white-space: nowrap'>
                                                ...
                                                //{
                                                ?>
                                                <a href='<?php echo site_url('params-modifier-menu/' . $value->id);  ?>' class='on-default btn_edit' id='<?php echo $value->id; ?>'>
                                                ...
                                                &nbsp;
                                                <a href="<?php echo site_url('params-details-menu/' . $value->id);  ?>" class='on-default btn_edit' id='<?php echo $value->id; ?>'>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".btn-primary").click(function() {
            var id = $(".hiddenid").val();
            $.ajax({
                url: '<?php echo site_url('params-supprimer-menu/') ?>' + id,
                //type: "GET",
                //dataType: "HTML",
                success: function(data) {
                    window.location.replace('params-liste-menu');
                },
