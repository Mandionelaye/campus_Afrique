...
<div class="card">
	<div class="card-body">
			...
			<div class="col-lg-10">
				<table class="table table-bordered table-striped">
					<tbody>
						<tr>
							<td>PAYS</td>
							<td><strong><?php echo $date_one_element['id_pays']; ?></strong></td>
						</tr>
						<tr>
							<td>LIBELLE</td>
		...
		<tr>
			<td>Supprimé?</td>
			<td><a href=<?php   echo site_url('params-supprimer-localite/'.$code_elt) ?> ><button type="button" class="btn btn-danger">Cliquer ici pour supprimer</button></a></td>
		</tr>
		<?php
			}
		?>
