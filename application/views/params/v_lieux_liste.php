...
?>
    <div class='row'>
        <div class='col-sm-12' style='margin-bottom: 30px'>
            <a href="<?php echo site_url('params-ajouter-lieux');  ?>">
                                     ...
                                     //   if($site_name == $value->id_source || $site_name=='ANSD')
                                      //  {
                                            ...
                                            <tr>
												...
												<td><?php echo $value->code_syscol; ?></td>
                                                <td><?php echo $value->nom_lieu; ?></td>
                                                <td>
                                                    <a href="<?php echo site_url('params-details-lieux/' . $value->id);  ?>" class='on-default btn_edit' id='<?php echo $value->id; ?>'>
													
                                                    <?php 
                                                         echo "<span class='badge bg-success rounded-pill'> &nbsp; Actif &nbsp; </span>"; 
?>
                                                    </a>
                                                </td>
                                                <td>
