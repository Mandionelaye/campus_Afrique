...
<div class="card">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-3">
			...
			<div class="well">
				<form method="POST" name="validation" action="<?php  echo site_url('ajouter-un-autre-piece')  ?>">
					...
					<div class="row mb-3">
						<div class="col-sm-4">
							<label class="text-center">Nom du piece</label>
						</div>
						<div class="col-sm-8">
							<?php
					...
					<div class="row mb-3">
						<div class="col-sm-4">
							<label class="text-center">Lieu d'obtention</label>
						</div>
						<div class="col-sm-8">
							<?php
