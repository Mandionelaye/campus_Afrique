            ...
            <div class="col-lg-4 col-md-8 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body" style="padding: 10px;">
                  ...
                  <div class="pt-4 pb-2" >
                    <h5 class="card-title text-center pb-0 fs-4">Partie administration pour les Responsables de Filière</h5>
                    <p class="text-center small">Saisissez votre login & mot de passe</p>
                  </div>

                  <!--form class="row g-3 needs-validation" novalidate-->
                  <form id="sign_in" method="POST" class="row g-3 needs-validation" action="<?php echo site_url('verif-connexion-respon'); ?>" novalidate> 
