...
<div class="card" align='center'>
	<div class="card-body">
	  <h5 class="card-title">Votre compte a été modifié avec succés merçi de vous reconnecter</h5>
	  ...
	  <div class="spinner-grow text-success" role="status">
		<span class="visually-hidden">Loading...</span>
			...
			<div class="alert alert-success alert-dismissible fade show" role="alert">
                ...
                <p>Félicitation votre mot de pass a été modifié avec succès</p>
                <hr>
                <p class="mb-0">Reconnecter vous maintenant.</p>
