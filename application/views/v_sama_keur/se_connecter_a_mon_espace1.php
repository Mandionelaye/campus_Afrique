...
<section class="section register min-vh-10 d-flex flex-column align-items-center justify-content-center py-4">
  <div class="container" >
            ...
            <form id="sign_in1" method="POST" class="row g-3 needs-validation" action="v-enter-my-space1" novalidate> 
              ...
              <div class="col-12">
                ...
                <div class="input-group has-validation">
                  ...
                  <span class="input-group-text" id="inputGroupPrepend"><input type="checkbox" id="showPassword"></span>
    ...
    <!-- Incluez jQuery dans votre vue -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

<!-- Ajoutez un script pour gérer le bouton Show Password -->
<script>
