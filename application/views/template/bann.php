                ...
                <div class="row" >
                  <div class="col-md-7" >
                    <div class="detail-box" >
                      ...
                      <a href="tel:+777777777"><i class="fa fa-phone-square" aria-hidden="true"></i></a>
                      <a href="mailto:assitasamb29@gmail.com"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                      <a href="http://"><i class="fa fa-map-marker" aria-hidden="true"></i></a>
                    </div>
                  </div>
                  <!-- div class="col-md-5 ">
                    <div class="img-box">
...
<section id="statistiques" class="dashboard" style="margin: 20px 14px -30px 14px ">
