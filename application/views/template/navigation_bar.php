...
$roles_admin = $this->session->roles_admin;
...
<aside id="sidebar" class="sidebar">
  <nav class="smk">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <?php
      if (isset($menu_roles['offres']) && $this->session->can8_g1qsu_30q9o['profil'] != 'responsable_filiere') {
      ?>
        <li class="nav-item">
          <a class="nav-smk " id="offre" onclick="changeStyleoffre()" data-bs-target="#dp-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-clipboard-data active"></i><span>Offres pédagogique</span><i class="bi bi-chevron-down ms-auto"></i>
          </a>
          <div id="damasonou">
      ...
      ?>
        <li class="nav-item">
          ...
          <i class="bi bi-building-fill"></i><span>Etablissement</span><i class="bi bi-chevron-down ms-auto"></i> 
          </a>
          <ul id="dp-nav-candidats" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <?php
            ///create_sub_menus(données venant de la table sys_sous_menus,url_venant_de_route.php,texte affiché, clase css
            create_sub_menus(@$smenu_roles['liste-offres']['d_read'], 'liste-Etablissement', 'Etablissement', 'bi bi-circle');
            ?>
          </ul>
        </li><!-- End collectes Nav -->
      <?php
