...
<div class="card">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-3">
			...
			<div class="well">
				<form method="POST" name="validation" action="<?php  echo site_url('offre-edite/'.$date_one_element['id'])  ?>">
					<?php //a dynamiser
					...
					<div class="row mb-3">
						<div class="col-sm-4">
							<label class="text-center">Date d'ouverture</label>
						</div>
						<div class="col-sm-8">
							<?php
								$val_var = !empty(set_value('date_publication')) ? set_value('date_publication') : '';
							?>
							<input type="date" class="form-control" value="<?php echo $date_one_element['date_publication']; ?>" name="date_publication">
					...
					<div class="row mb-3">
						<div class="col-sm-4">
							<label class="text-center">Date de fermeture</label>
						</div>
						<div class="col-sm-8">
							<?php
								$val_var = !empty(set_value('date_cloture')) ? set_value('date_cloture') : '';
							?>
							<input type="date" class="form-control" value="<?php echo $date_one_element['date_cloture']; ?>" name="date_cloture">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-8">
							...
							<textarea name="text_details"  class="form-control" 
											rows="2"><?php echo $date_one_element['text_details']; ?></textarea>
