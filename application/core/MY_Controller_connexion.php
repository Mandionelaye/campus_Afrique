...
//demba_debug($data_user);			
	...
	protected function start_session_ecole($data_user)
	{
...
//demba_debug($data_user);			
		...
		//	$ien 		=  $data_user['can8_g1qsu_30q9o']['ien'];
			...
			$tab_smrole	= array();  ///Tableau des roles des sous menus
			$cur_menu	= '';
			$tab_role	= $this->role->get_conn_roles_ecole($id_profil, $id_site);
			...
			$this->session->set_userdata('menu_roles', $data['menu_roles']);
			$this->session->set_userdata('smenu_roles', $data['smenu_roles']);
			$this->session->set_userdata('roles_admin', $id_profil);
			//BAKS FIN Recuperation des roles
	...
	protected function start_session_resp($data_user)
	{
...
//demba_debug($data_user);			
		...
		//	$ien 		=  $data_user['can8_g1qsu_30q9o']['ien'];
			...
			$tab_smrole	= array();  ///Tableau des roles des sous menus
			$cur_menu	= '';
			$tab_role	= $this->role->get_conn_roles_resp($id_profil, $id_site);
