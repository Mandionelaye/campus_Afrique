		...
		{		
			...
			//demba_debug($next_code);
				...
				if ($result_add == '1') //si insertion avec succés on redirige
				{
					...
					$message='<h1><b><center>Inscription Réussie plateforme candidature</b></h1></center><br>
					 <p>Merci de cliquer sur ce lien: http://localhost/campus-afrique/acceder-a-son-espace/ </p>
					 <img src="assets/img/profile-img.jpg" width="100" alt="Profile" >'; //é = &eacute;      è = &egrave;
			/*
						$config = array(
							'protocol' =>'ssmtp',
