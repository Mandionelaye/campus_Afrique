...
//demba_debug($new_date);
    ...
    function diff_n_jour_2($date_cloture)
    {
        ...
        $diff_en_secondes = $timestamp2 - $timestamp1;
        $diff_en_jours = $diff_en_secondes / (24 * 60 * 60);
        //demba_debug($diff_en_jours);

        return $diff_en_jours;
    }
