    ...
    <div class="container" >
      ...
      <section class="section register min-vh-60 d-flex flex-column align-items-center justify-content-center py-4">
            ...
            <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body" style="padding: 10px;">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Entrer sur votre espace perso</h5>
                    <p class="text-center small">Saisissez votre login</p>
                  </div>

                  <!--form class="row g-3 needs-validation" novalidate-->
                  <form id="sign_in" method="POST" class="row g-3 needs-validation" action="v-enter-my-space" novalidate> 
