    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo site_url('traiter-fichier-experience'); ?>" id="form_cour_divcrud" class="form-horizontal requires-validation" novalidate method="post" enctype="multipart/form-data" novalidate="novalidate">
