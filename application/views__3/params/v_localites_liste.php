...
?>
    <div class='row'>
        <div class='col-sm-12' style='margin-bottom: 30px'>
            <a href="<?php echo site_url('params-ajouter-localite');  ?>">
                                    ...
                                    <?php foreach ($all_data as $value) 
                                    {
                                     //   if($site_name == $value->id_source || $site_name=='ANSD')
                                      //  {
                                            ?>
                                            <tr>
                                                <td><?php echo $value->id_pays; ?></td>
                                                <td><?php echo $value->libelle; ?></td>
                                                <td><?php echo $value->etat; ?></td>                                                
                                                 <td>   <a href="<?php echo site_url('params-details-localites/' . $value->id);  ?>" class='on-default btn_edit' id='<?php echo $value->id; ?>'>
                                                    <?php 
                                                        if($value->etat=='1')
                                                            {
