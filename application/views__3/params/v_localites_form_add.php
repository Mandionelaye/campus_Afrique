...
<div class="card">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-3">
			...
			<div class="well">
				<form method="POST" name="validation" action="<?php  echo site_url('params-ajouter-localite')  ?>">
					<?php //a dynamiser
					...
					<div class="row mb-3">
						<div class="col-sm-4">
							<label class="text-center">Pays</label>
						</div>
						<div class="col-sm-8">
							<?php
								$val_var = !empty(set_value('id_pays')) ? set_value('id_pays') : '';
							?>
							<input type="text" class="form-control" value="<?php echo $val_var; ?>" name="id_pays">
                    ...
                    <div class="row mb-3">
						<div class="col-sm-4">
							<label class="text-center">Parent</label>
						</div>
						<div class="col-sm-8">
							<?php
