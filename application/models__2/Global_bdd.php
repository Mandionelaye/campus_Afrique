...
////////////////////////////////////////////////logs end
	...
	////////////retourne en dur les vlaurs sous forme de tableau									
	public function get_data_for_combo_static($table)
	{	
...
//echo $req_sql;
	...
	//select libelle from lst_annee_scolaire where id=$the_year
