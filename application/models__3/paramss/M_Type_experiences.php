<?php
class M_Type_experiences extends  MY_Model
{
   ...
   {
      return $this->db->insert('lst_type_experiences', $data);
   }
   ...
   function update_one_s($id_val, $data)
   {
      ...
      return $this->db->update('lst_type_experiences', $data);
   }
}
