          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8"><?php echo $this->session->can8_g1qsu_30q9o['profil'] ?></div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8"><?php echo show_state_user_color($date_one_element['etat']); ?></div>
              </div>
            ...
            <div class="tab-pane fade pt-3" id="profile-change-password">
              ...
              <form>
                ...
                <div class="row mb-3">
                  <label for="currentPassword" class="col-md-4 col-lg-3 col-form-label">Mot de pass actuel</label>
                  <div class="col-md-8 col-lg-9">
                ...
                <div class="row mb-3">
                  <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Confirmation du nouveau mot de </label>
                  <div class="col-md-8 col-lg-9">
