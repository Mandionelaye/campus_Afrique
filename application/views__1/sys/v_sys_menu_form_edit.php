	...
	<div class="card-body">
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-3">
				...
				<div class="well">
					<form method="POST" name="validation" action="<?php echo site_url('params-modifier-menu/' . $code_elt); ?>">
						<?php //a dynamiser
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<?php
								$val_var = !empty(set_value('rang')) ? set_value('rang') : $dat_one_elt['rang'];
								?>
								<input type="text" class="form-control" value="<?php echo $val_var; ?>" name="rang">
