...
<form id="form_role" method="post" action="<?php echo site_url('C_sys_profil/save_role_action')   ?>">
<input type="hidden" name="id_role_profil" id="id_role_profil" value="<?php echo $id_profil /* echo $id_profil[0] a revoir avec bakary coupe quadn cela depaase 10 */ ?>">
<input type="submit" id="btn-role-save" class="btn btn-lg btn-success" value="Enregistrer"/>
<br><br>
<legend></legend>
