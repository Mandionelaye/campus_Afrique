...
?>
    <div class='row'>
        <div class='col-sm-12' style='margin-bottom: 30px'>
            <a href="<?php echo site_url('ajouter-un-diplome');  ?>">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo site_url('traiter-fichier-diplomes'); ?>" id="form_cour_divcrud" class="form-horizontal requires-validation" novalidate method="post" enctype="multipart/form-data" novalidate="novalidate">
                    ...
                    <input type="submit" class="btn" style="background-color: #012970; color:white" id="autorisation_control" value="Enregistrer">
                </form>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td align='center'>
                                                ...
                                                ?>
                                                    <a href="<?php echo site_url('supprimer-image-diplome/' . $value->id) ?>" class="on-default " num_img="1" id="<?php echo $value->id; ?>">
