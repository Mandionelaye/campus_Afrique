                                     ...
                                     //   if($site_name == $value->id_source || $site_name=='ANSD')
                                      //  {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('visualiser-details-offre?offre=	' . $value->id);  ?>" class='on-default btn_edit' id='<?php echo $value->id; ?>'>
                                                    <?php 
                                                        if($value->etat=='1')
                                                            {

                                                                echo "<span class='badge bg-success rounded-pill'> Détails </span>"; 

                                                            }
                                                        else
                                                            echo "<span class='badge bg-danger rounded-pill'> Détails </span>"; 
                                                    ?>
                                                    </a>
                                                </td>
                                                <!--td>
